...
def read_sigmet(
    ...
    **kwargs
    ...
    3: "H+V",
    4: "H+V"}
    metadata["polarization"] = pol_mode[int(task_config["task_misc_info"]['polarization_type'])]
    #END EDITED SECTION
    ...
    elevation["start"] = el0.astype("float32")
    elevation["stop"] = el1.astype("float32")
    #END OF EDITING
    # instrument_parameters
    wavelength = filemetadata("wavelength") #modified Nanda 18 JAN 2024
    ...
    wavelength["data"] = wavelength_cm * np.ones(total_rays, dtype="float32") #modified Nanda 18 JAN 2024
    instrument_parameters = {
        "wavelength": wavelength, #modified Nanda 18 JAN 2024
...
#CHANGE [metadata.keys()[0]] to [list(metadata.keys())[0]] NANDA 18 JAN 2024
